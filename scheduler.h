...
/* Configure dynamic ceiling priority protocol.*/
#define schedCP_PROTOCOL_ICPP 1
#define schedCP_PROTOCOL_OCPP 2

/* Configure dynamic ceiling priority protocol by setting this define to the appropriate one. */
#define schedCP_PROTOCOL schedCP_PROTOCOL_ICPP //schedCP_PROTOCOL_OCPP
...
{
	SemaphoreHandle_t xSemaphore;		/* Semaphore of the Resource. */ 
	UBaseType_t xCeilingPriority;		/* Ceiling Priority of the Resource. */ 
	bool xInUse = pdFALSE;				/* Flag to check if Resource is being used. */
	TaskHandle_t *xUserTask;			/* To store task handle of resource holder */
	UBaseType_t xUserTaskPriority;		/* To store previous priorities of tasks */

} Res;

/* Takes number of resources & ceiling priorities for resources*/
...
/* Function to be called when resource is to be released. Parameters: Resource, task handle of caller */
